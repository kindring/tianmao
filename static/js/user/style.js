(function (window, document) {
    ...
    SliderBar.prototype = {
        ...
        reToNewImg: function () {
            ...
            var imgSrc = "/static/imgs/images/" + _this.imgList[index] + "";
        ...
        mousedown: function (_this, e) {
            ...
            function mouseup() {
                ...
                if(_this.resultX > (left - 2) && _this.resultX < (left + 2)){
                    ...
                    var qdingT = document.getElementsByClassName('qdingT');
                    var pduan = document.getElementsByClassName('pduan');
                    document.getElementById('pduan1').value = 1;
                    qdingT[0].style.background = '#f03';
                    // qdingT[0].disabled = false;
                    $('.qdingT').removeAttr("disabled");
                    qdingT[0].style.color = 'white';
                    // document.getElementById('keclick').style.background = 'red';
                }else{
